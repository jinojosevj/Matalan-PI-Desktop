...
{
    public partial class NegativeCount : Form
    {
        ...
        private void btnNew_Click(object sender, EventArgs e)
        {
            ...
            dgvNegative.DataSource = null;
        }
        #endregion btnNew_Click


        #region btnExportNegative_Click
        /// <summary>
        /// btnExportNegative_Click
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void btnExportNegative_Click(object sender, EventArgs e)
        {
            saveFileDialog1.Filter = "CSV Files | *.csv";
            saveFileDialog1.DefaultExt = "csv";
            saveFileDialog1.FileName = "NA_Data.csv";
            saveFileDialog1.ShowDialog();

            PICountBL ObjPI = new PICountBL();
            DataTable dt = ObjPI.ExportBarcodesForPdt();


            for (int i = 0; i < dt.Rows.Count; i++)
            {
              //  dt.Rows[i]["BCD"] = Common.Base64Encode(dt.Rows[i]["BCD"].ToString());
                dt.Rows[i]["BCD"] = dt.Rows[i]["BCD"].ToString();
            }
            ...
            ExportToCsvWithOutHeader(dt, sw);

            sw.Close();

            ObjPI.DocNo = txtDocumentNo.Text;
            dt = ObjPI.GetNegativeReport();
            dgvNegative.DataSource = dt;
            lblBarcodeFile.Text = saveFileDialog1.FileName;

            lblMessage.Text = "Successfully Exported";
            lblMessage.ForeColor = System.Drawing.Color.Green;

        }
        #endregion btnExportNegative_Click

        #region cmbDocNo_SelectedIndexChanged
        /// <summary>
        /// cmbDocNo_SelectedIndexChanged
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void cmbDocNo_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            dgvNegative.DataSource = dtPI;
        }
        #endregion cmbDocNo_SelectedIndexChanged
        ...
        private void btnReport_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt = ObjPI.GetNegativeReport();
            if (dt.Rows.Count > 0)
            {
                dgvNegative.DataSource = dt;
        ...
        private void btnExportAdj_Click(object sender, EventArgs e)
        {
            saveFileDialog1.Filter = "CSV Files | *.csv";
            saveFileDialog1.DefaultExt = "csv";
            saveFileDialog1.FileName = "NA_" + txtDocumentNo.Text.Trim().ToString() + "_" + DateTime.Now.Day + DateTime.Now.Month + DateTime.Now.Year + "_" + DateTime.Now.Ticks.ToString().Substring(0, 5);
            saveFileDialog1.ShowDialog();
        ...
        #region Generate Negative Report
        /// <summary>
        /// Generate Negative Report
        /// </summary>
        private void GenerateNegativeReport()
        {
            //try
            //{
            ...
            WriteToExcelNAHeader(dtPI, xlSheet);

            dtPI = ObjPI.ExportPIVarianceReport();

            if (dtPI.Rows.Count > 0)
            {
                WriteToExcelNADetail(dtPI, xlSheet);
        ...
        #endregion GenerateNegativeReport

        #region WriteToExcelNAHeader
        /// <summary>
        /// WriteToExcelNAHeader
        /// </summary>
        /// <param name="dtStock"></param>
        /// <param name="myExcelWorksheet"></param>
        /// <param name="location"></param>
        private void WriteToExcelNAHeader(DataTable dtSalary, Excel1.Worksheet myExcelWorksheet)
        {
            object misValue = System.Reflection.Missing.Value;
        ...
        #endregion WriteToExcelNAHeader

        #region WriteToExcelNADetail
        /// <summary>
        /// WriteToExcelNADetail
        /// </summary>
        /// <param name="dtStock"></param>
        /// <param name="myExcelWorksheet"></param>
        /// <param name="location"></param>
        private void WriteToExcelNADetail(DataTable dtSalary, Excel1.Worksheet myExcelWorksheet)
        {
            object misValue = System.Reflection.Missing.Value;
        ...
        #endregion WriteToExcelNADetail
        ...
        #region Export To Csv WithOut Header
        /// <summary>
        /// Export To Csv
        /// </summary>
        /// <param name="dt"></param>
        private void ExportToCsvWithOutHeader(DataTable dt, StreamWriter sw)
        {
        ...
        #endregion ExportToCsvWithOutHeader
